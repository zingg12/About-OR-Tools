...
konversi = 111.12 #konversi dari satuan derajat ke kilometer
...
distance_manhattan = manhattan(lat1, lon1, lat2, lon2)
...
#create data
umn = Point('-6.257504, 106.618165')
mayora = Point('-6.15856, 106.695013')

distance_vincenty = geodesic(umn, mayora).km
...
umn = (-6.257504, 106.618165)
mayora = (-6.15856, 106.695013)
distance_vincenty_2 = vincenty(umn, mayora) / 1000
...
print('Jarak (Kilometer) Antara UMN dengan Mayora berdasarkan 4 Algoritma adalah: \n', df, '\n Jarak berdasarkan GMaps adalah 17km')